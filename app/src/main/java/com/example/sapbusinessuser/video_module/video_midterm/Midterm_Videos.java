package com.example.sapbusinessuser.video_module.video_midterm;
...
import com.example.sapbusinessuser.adapters.VideoTopicsList_Adapter;
...
public class Midterm_Videos extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if(getSupportActionBar()==null){
            ...
            getSupportActionBar().setTitle("Midterm Videos");
