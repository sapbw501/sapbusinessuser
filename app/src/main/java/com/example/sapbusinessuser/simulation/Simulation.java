...
import com.example.sapbusinessuser.simulation.sap_activity.SapMainActivity;
...
public class Simulation extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* simul1 = findViewById(R.id.simulation1);
        ...
        simul5 = findViewById(R.id.simulation5);
        simul5.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View view){
                startActivity(new Intent(Simulation.this, SapMainActivity.class));
            }
