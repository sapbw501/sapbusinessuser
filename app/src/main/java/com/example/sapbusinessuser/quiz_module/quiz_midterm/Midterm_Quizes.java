package com.example.sapbusinessuser.quiz_module.quiz_midterm;
...
import com.example.sapbusinessuser.adapters.QuizTopicsList_Adapter;
...
public class Midterm_Quizes extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if(getSupportActionBar()==null){
            ...
            getSupportActionBar().setTitle("Midterm Quizzes");
